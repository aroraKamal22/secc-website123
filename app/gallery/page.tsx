...
const galleryImages = [
  ...
  { src: '/images/media6.png', title: 'Laboratory Area', description: 'Advanced Testing Facilities', category: 'equipment' },
  { src: '/images/media7.png', title: 'Patient Waiting Area', description: 'Comfortable & Spacious Lounge', category: 'patients' },
  { src: '/images/media8.png', title: 'Consultation Room', description: 'Private Consultation Chambers', category: 'facility' },
  { src: '/images/media9.png', title: 'Patient Recovery', description: 'Comfortable Patient Experience', category: 'patients' },
  { src: '/images/Reception.png', title: 'Reception Area', description: 'Welcoming Front Desk', category: 'facility' },
  { src: '/images/glasses.png', title: 'Optical Shop', description: 'Premium Eyewear Collection', category: 'facility' },
  { src: '/images/sarswati_rajesh.png', title: 'Dr. Rajesh Garg', description: 'Founder & Chairman', category: 'team' },
